...
## Overview
HoloMusem is a set of educational MR experiences about nature.There are three chapters (Ocean Dream, Dinosaur World and Forest Fantasy) now and growing. It is the main income source of the company right now.	
...
![Photo of the persona creation session](../images/projectImages/2020/holomuseum/persona_1.png)
<figcaption>Persona sets including three personas</figcaption>
![Photo of the persona creation session](../images/projectImages/2020/holomuseum/persona_2.png)
![Photo of the persona creation session](../images/projectImages/2020/holomuseum/persona_3.png)
...
![Screenshot and diagram of the loop ](../images/projectImages/2020/holomuseum/loop.png)
...
### First iteration: simple arrow with icon
...
![Screenshot the meat icon ](../images/projectImages/2020/holomuseum/object%20indicator_first%20iteration.png)

### Second iteration: animated arrow
...
![Video of the new design ](../images/projectImages/2020/holomuseum/object%20indicator_first%20iteration.png)
...
## Outcome
To test out the new version of content and feedbacks of real paid customers, we opened a pop-up store in Shenzhen in December 2019.
